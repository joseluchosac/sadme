...
type UsersColumnSortProps = {
  col: TableColumn;
  usersQrystr: InertiaFormProps<Qrystr>;
}

export default function UsersColumnSort({col, usersQrystr}: UsersColumnSortProps) {
  ...
  const handleSort = (order: 'asc' | 'desc' | null) => {
    ...
    usersQrystr.setData({ ...usersQrystr.data, sortby, page: '1' });
  }
